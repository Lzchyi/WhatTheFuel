    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="mt-20 border-t border-stone-800 bg-stone-900 py-12 text-stone-400 dark:bg-black">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 sm:px-6 lg:flex-row lg:px-8">
          <div className="flex w-full items-center justify-center gap-2 lg:justify-start"><Droplets size={20} className="text-amber-600" /><span className="font-serif text-xl font-bold text-stone-200">WhatTheFuel</span></div>
        </div>
      </footer>
    </div>
  );
