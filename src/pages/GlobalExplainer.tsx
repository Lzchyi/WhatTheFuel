...
import { globalSections } from '../lib/editorial';
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-12">
        ...
        <h1 className="mb-6 text-4xl font-bold leading-tight text-stone-900 dark:text-stone-100 md:text-5xl">Why petrol gets expensive</h1>
        <p className="text-xl leading-relaxed text-stone-600 dark:text-stone-400">Global oil shocks move through shipping, inventories, futures, and refining margins before they show up in a domestic pump price.</p>
      </div>
      ...
      <div className="mt-8 rounded-3xl border border-amber-100 bg-amber-50 p-6 text-amber-900 dark:border-amber-900/30 dark:bg-amber-900/10 dark:text-amber-200">
        <div className="mb-2 flex items-center gap-2 font-bold"><ShieldAlert size={18} /> What the page is not doing</div>
        <p className="leading-relaxed">This page is not a claim that every global move hits Malaysia immediately. It explains the mechanism, the lag, and why a shipping shock or inventory squeeze can still matter even when local politics has not changed.</p>
      </div>
    </div>
  );
}
