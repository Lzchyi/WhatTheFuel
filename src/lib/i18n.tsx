...
const translations: Record<Language, Dict> = {
  en: {
    ...
    'prices.ron97': 'RON97',
    'prices.diesel_peninsular': 'Diesel Peninsular',
    'prices.diesel_east': 'Diesel Sabah / Sarawak / Labuan',
  ...
  ms: {
    ...
    'prices.ron97': 'RON97',
    'prices.diesel_peninsular': 'Diesel Semenanjung',
    'prices.diesel_east': 'Diesel Sabah / Sarawak / Labuan',
  ...
  zh: {
    ...
    'prices.ron97': 'RON97',
    'prices.diesel_peninsular': '半岛柴油',
    'prices.diesel_east': '沙巴 / 沙捞越 / 纳闽柴油',
