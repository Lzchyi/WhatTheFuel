...
const translations: Record<Language, Dict> = {
  ...
  ms: {
    ...
    'prices.quota.1': 'Kelayakan umum di bawah BUDI95 masih dihadkan sementara pada 200 liter sebulan.',
    'prices.quota.2': 'Pemandu e-hailing yang berkelayakan layak menerima sehingga 800 liter sebulan, melalui kelayakan berasaskan tier berperingkat.',
    'prices.quota.3': 'Bantuan tunai BUDI Diesel diformulasikan sebagai sokongan bersasar, dan bukan subsidi bahan api semberono.',
  ...
  zh: {
    ...
    'prices.quota.1': '在现有 BUDI95 框架下，一般常规合格者每月补贴汽油使用配额维持在200公升。',
    'prices.quota.2': '针对电召车业者等符合资格的使用者，依照分级制度，配额可达至每月800公升。',
    'prices.quota.3': 'BUDI 柴油补贴仍然列入针对性援助范围，绝非全面燃油补贴计划覆盖面。',
    'sources.updated': '更新于',
