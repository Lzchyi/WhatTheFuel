...
const translations: Record<Language, Dict> = {
  ...
  ms: {
    ...
    'footer.disclaimer': 'WhatTheFuel menerangkan berita dan dasar harga minyak dengan pautan sumber. Item langsung boleh kekal dalam bahasa asal.',
  ...
  zh: {
    ...
    'footer.disclaimer': 'WhatTheFuel 通过来源链接解释油价新闻和政策。实时条目可能保留原始语言。',
