...
const ms: EditorialCopy = {
  ...
  global: {
    title: 'Kenapa Harga Minyak Dunia Boleh Naik',
    intro: 'Harga minyak dunia bergerak melalui kapal, stok, pasaran hadapan, dan kilang — sebelum sampai ke harga pam tempatan.',
  ...
  malaysia: {
    title: 'Kenapa Malaysia Pun Terkesan',
    intro: 'Malaysia mengeluarkan minyak, tapi kita masih dalam sistem perdagangan bahan api global yang sama, import gred produk yang diperlukan, dan guna subsidi bersasar untuk kurangkan kesan kepada pengguna.',
